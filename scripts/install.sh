...
# Installs the CityGuard Edge Monitor dashboard from a reviewed release
# already copied to /opt/cityguard-edge-monitor (mirrors edge/scripts/
# install-pi-runtime.sh's pattern -- this script does not clone anything).
